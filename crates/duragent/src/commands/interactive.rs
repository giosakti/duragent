...
use duragent::client::{AgentClient, ApprovalDecision, ApproveCommandResponse, ClientStreamEvent};
...
pub async fn stream_response(
    mut stream: impl futures::Stream<Item = duragent::client::Result<ClientStreamEvent>> + Unpin,
) -> Result<StreamResult> {
